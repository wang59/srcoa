 ...
 */
@Entity
@Table(name = "t_s_online_doc_interface_subdirectory", schema = "")
@SuppressWarnings("serial")
public class DocInterfaceSubdirectoryEntity implements java.io.Serializable {
	/**主键*/
...
//	private java.lang.String sysCompanyCode;
	...
	@Column(name ="service_url",nullable=true,length=300)
	...
	@Column(name ="request_mode",nullable=true,length=10)
	public String getRequestMode() {
		return requestMode;
	}
	@Column(name ="resultant",nullable=true,length=2000)
	...
	@Column(name ="operation_type",nullable=true,length=15)
