...
<t:datagrid name="jeecgDemoList2" title="行编辑示例"  actionUrl="jeecgDemoController.do?datagrid"
	...
	<t:dgCol title="用户名" field="userName" query="true"  extendParams="editor:userConfig'"></t:dgCol>
...
var userConfig={type:'combobox',options:{valueField:'productid',textField:'productname',url:'http://127.0.0.1:8080/temp/products.json',required:true}};
	//添加行
