...
<t:formvalid formid="formobj" dialog="true"  beforeSubmit="" usePlugin="password"  layout="table" tiptype="1"  action="synDSController.do?synCgFormHeader">
<table cellpadding="0" cellspacing="1" class="formtable">
	<input type="hidden" name="id" value="${cgFormHeadPage.id}">
		<tr>
...
<script type="text/javascript" src="webpage/jeecg/cgform/config/syndatasource.js"></script>
</body>
