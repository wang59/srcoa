...
<t:datagrid name="coordinatelist" title="任务协调单查询" actionUrl="coordinateController.do?coordinategrid&type=1" idField="id" fit="true" queryMode="group" queryBuilder="true" sortName="businessCreateTime" sortOrder="desc">
	<t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="创建人" field="businessCreateBy" hidden="true"></t:dgCol>
	<t:dgCol title="流水号" field="serialnumber"    width="120" query="true" ></t:dgCol>   
	...
	<t:dgCol title="任务名称" field="coordinateEntity.taskname"  query="true"  width="120"></t:dgCol>	
	 <t:dgCol title="协调人" field="businessCreateName" query="false"   width="60"></t:dgCol>
