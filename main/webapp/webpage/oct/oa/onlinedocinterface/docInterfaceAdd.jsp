...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="onlineDocInterfaceController.do?doAdd">
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value">
					<input class="inputxt" id="name" name="name" ignore="ignore" value="" style="vertical-align: middle;"/>
					<span class="Validform_checktip"></span>
				</td>
			</tr>
		</table>
