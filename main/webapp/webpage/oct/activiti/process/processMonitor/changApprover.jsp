...
<t:base type="jquery,easyui,tools"></t:base>
	<script type="text/javascript">
		function openUserSelect() {
		   ...
		   $.dialog({content: 'url:userController.do?userselectauto', zIndex: 2105, title: '用户列表', lock: true, width: '800px', height: '690px', opacity: 0.4, button: [
...
<table>
 <tr>
    <td>原审批人：</td>
    <td><input type="text" value="${user.realName }"></button><br>
  </tr>
  <tr>
    <td>修改审批人为：</td>
