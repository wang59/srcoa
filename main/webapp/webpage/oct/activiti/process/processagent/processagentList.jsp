...
<t:datagrid name="processAgentlist" title="流程代理" actionUrl="processAgentController.do?processAgentgrid" idField="id" fit="true" queryMode="group" queryBuilder="true">
	...
	<t:dgToolBar  title="新建代理" icon="icon-add" url="processAgentController.do?add" funname="add"></t:dgToolBar>
</t:datagrid>
